...
public class M12_Recursion {
    ...
    public static void main(String[] args)throws IOException {
        ...
        int A=sc.nextInt();
        int B=sc.nextInt();
        out.println(getMin(n,k,A,B,true));
        out.flush();
    }

    private static int getMin(int n, int k, int a, int b,boolean bbx) {
        debug(n+"  "+bbx);
        if(n==1) return 0;
        int v1=getMin(n-1,k,a,b,true) + a;
        int v2= n%k==0 ? getMin(n/k,k,a,b,false) +b : Integer.MAX_VALUE;
//        debug(n+" "+(v1<v2 ? v1 : v2));
        return v1<v2 ? v1 : v2;
    }
}
