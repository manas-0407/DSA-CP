...
public class FlipTheBits {
    ...
    public static void main(String[] args)throws IOException {
        ...
        manas : while (t-- > 0 ){
            ...
            while (j<al.size()){
                boolean firstmove=true,same=false,diff=false;
                while (i>al.get(j)){
                    if(firstmove){
                        if(a.charAt(i)==b.charAt(i)) same=true;
                        else diff=true;
                        firstmove=false;
                    }
                    else {
                        if((same && a.charAt(i)!=b.charAt(i)) || (diff&&a.charAt(i)==b.charAt(i))) {
                            out.println("NO");
                            continue manas;}
                    }
                    i--;
