...
public class CSESTowerOfHanoi {
    ...
    static long tower(int n,int scr,int hlp,int dest){
        if(n==0) return 0;
        long step1=tower(n-1,scr,dest,hlp);
        out.append(scr).append(" ").append(dest).append("\n");
        long step2= tower(n-1,hlp,scr,dest);
        return step1+step2+1;
    }
    public static void main(String[] args)throws IOException {
        int n=sc.nextInt();
        long step = tower(n,1,2,3);
